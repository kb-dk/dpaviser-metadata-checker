package dk.statsbiblioteket.dpaviser.metadatachecker.mockers;

import dk.statsbiblioteket.dpaviser.metadatachecker.MetadataCheckerComponent;
import dk.statsbiblioteket.dpaviser.metadatachecker.MetadataChecksFactory;
...
public class MockupIteratorSuper extends MetadataCheckerComponent {
    ...
    protected MetadataChecksFactory getMetadataChecksFactory(Batch batch, ResultCollector resultCollector,
        ...
        return new MetadataChecksFactory(resultCollector, batch, batchXmlStructure, null) {
            @Override
